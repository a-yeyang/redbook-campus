package com.yeyang.redbook.data.align.consumer;

import com.yeyang.framework.common.util.JsonUtils;
import com.yeyang.redbook.data.align.constant.MQConstants;
import com.yeyang.redbook.data.align.constant.RedisKeyConstants;
import com.yeyang.redbook.data.align.constant.TableConstants;
import com.yeyang.redbook.data.align.domain.mapper.InsertMapper;
import com.yeyang.redbook.data.align.model.dto.CollectUnCollectNoteMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "redbook_group_data_align_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT, // Group 组
