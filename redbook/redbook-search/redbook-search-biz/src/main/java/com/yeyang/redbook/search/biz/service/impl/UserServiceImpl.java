package com.yeyang.redbook.search.biz.service.impl;
...
import com.yeyang.redbook.search.biz.domain.mapper.SelectMapper;
import com.yeyang.redbook.search.biz.index.NoteIndex;
import com.yeyang.redbook.search.biz.index.UserIndex;
...
public class UserServiceImpl implements UserService {
    ...
    public PageResponse<SearchUserRspVO> searchUser(SearchUserReqVO searchUserReqVO) {
        ...
        // 构建 multi_match 查询，查询 nickname 和 redbook_id 字段
        sourceBuilder.query(QueryBuilders.multiMatchQuery(
                keyword, UserIndex.FIELD_USER_NICKNAME, UserIndex.FIELD_USER_redbook_ID));
        ...
        try {
            ...
            for (SearchHit hit : hits) {
                ...
                String redbookId = (String) sourceAsMap.get(UserIndex.FIELD_USER_redbook_ID);
