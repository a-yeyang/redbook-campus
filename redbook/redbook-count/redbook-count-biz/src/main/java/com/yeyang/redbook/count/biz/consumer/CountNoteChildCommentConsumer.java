...
import com.yeyang.redbook.count.biz.domain.mapper.CommentDOMapper;
import com.yeyang.redbook.count.biz.enums.CommentLevelEnum;
import com.yeyang.redbook.count.biz.model.dto.CountPublishCommentMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "redbook_group_child_comment_total" + MQConstants.TOPIC_COUNT_NOTE_COMMENT, // Group 组
