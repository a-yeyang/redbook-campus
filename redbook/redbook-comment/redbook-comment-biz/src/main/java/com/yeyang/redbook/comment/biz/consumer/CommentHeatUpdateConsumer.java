...
import com.yeyang.redbook.comment.biz.model.bo.CommentHeatBO;
import com.yeyang.redbook.comment.biz.util.HeatCalculator;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "redbook_group_" + MQConstants.TOPIC_COMMENT_HEAT_UPDATE, // Group 组
