package com.yeyang.redbook.comment.biz.service.impl;
...
import com.yeyang.redbook.comment.biz.domain.dataobject.CommentLikeDO;
...
import com.yeyang.redbook.comment.biz.domain.mapper.NoteCountDOMapper;
import com.yeyang.redbook.comment.biz.enums.*;
...
import com.yeyang.redbook.comment.biz.model.vo.*;
import com.yeyang.redbook.comment.biz.retry.SendMqRetryHelper;
import com.yeyang.redbook.comment.biz.rpc.DistributedIdGeneratorRpcService;
import com.yeyang.redbook.comment.biz.rpc.KeyValueRpcService;
import com.yeyang.redbook.comment.biz.rpc.UserRpcService;
import com.yeyang.redbook.comment.biz.service.CommentService;
import com.yeyang.redbook.kv.dto.req.FindCommentContentReqDTO;
...
public class CommentServiceImpl implements CommentService {
    ...
    private void getChildCommentDataAndSync2Redis(List<CommentDO> childCommentDOS, List<FindChildCommentItemRspVO> childCommentRspVOS) {
        ...
        for (CommentDO childCommentDO : childCommentDOS) {
            ...
            // 若当前评论的 replyCommentId 不等于 parentId，则前端需要展示回复的哪个用户，如  “回复 coder：”
