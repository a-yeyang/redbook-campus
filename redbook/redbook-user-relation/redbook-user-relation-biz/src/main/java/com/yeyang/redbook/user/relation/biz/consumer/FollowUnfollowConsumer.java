package com.yeyang.redbook.user.relation.biz.consumer;
...
import com.yeyang.redbook.user.relation.biz.enums.FollowUnfollowTypeEnum;
import com.yeyang.redbook.user.relation.biz.model.dto.CountFollowUnfollowMqDTO;
 ...
 **/
@Component
@RocketMQMessageListener(consumerGroup = "redbook_group_" + MQConstants.TOPIC_FOLLOW_OR_UNFOLLOW, // Group 组
