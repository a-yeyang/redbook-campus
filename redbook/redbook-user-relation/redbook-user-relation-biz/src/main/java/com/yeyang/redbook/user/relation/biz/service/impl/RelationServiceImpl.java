package com.yeyang.redbook.user.relation.biz.service.impl;
...
import com.yeyang.framework.common.util.DateUtils;
import com.yeyang.framework.common.util.JsonUtils;
import com.yeyang.redbook.user.dto.resp.FindUserByIdRspDTO;
import com.yeyang.redbook.user.relation.biz.constant.MQConstants;
import com.yeyang.redbook.user.relation.biz.constant.RedisKeyConstants;
import com.yeyang.redbook.user.relation.biz.domain.dataobject.FansDO;
import com.yeyang.redbook.user.relation.biz.domain.dataobject.FollowingDO;
import com.yeyang.redbook.user.relation.biz.domain.mapper.FansDOMapper;
import com.yeyang.redbook.user.relation.biz.domain.mapper.FollowingDOMapper;
import com.yeyang.redbook.user.relation.biz.enums.LuaResultEnum;
import com.yeyang.redbook.user.relation.biz.enums.ResponseCodeEnum;
import com.yeyang.redbook.user.relation.biz.model.dto.FollowUserMqDTO;
import com.yeyang.redbook.user.relation.biz.model.dto.UnfollowUserMqDTO;
import com.yeyang.redbook.user.relation.biz.model.vo.*;
import com.yeyang.redbook.user.relation.biz.rpc.UserRpcService;
import com.yeyang.redbook.user.relation.biz.service.RelationService;
...
public class RelationServiceImpl implements RelationService {
    ...
    public Response<?> follow(FollowUserReqVO followUserReqVO) {
        ...
        persistFollow(userId, followUserId, now);
        redisTemplate.opsForZSet().add(RedisKeyConstants.buildUserFansKey(followUserId), userId, timestamp);
    ...
    public Response<?> unfollow(UnfollowUserReqVO unfollowUserReqVO) {
        ...
        persistUnfollow(userId, unfollowUserId);
    ...
    private void persistFollow(Long userId, Long followUserId, LocalDateTime createTime) {
    ...
    private void persistUnfollow(Long userId, Long unfollowUserId) {
        transactionTemplate.executeWithoutResult(status -> {
